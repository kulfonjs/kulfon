  ...
  for (let f of files) {
    ...
    switch (path.extname(f)) {
      ...
      case ".html":
        ...
        output = nunjucks.render(path.parse(f).base, { config });
      ...
      case ".scss":
        ...
        break;
      case ".js":
        fs.copyAsync(path.join(currentDirectory, 'website/javascripts', f), __public(f, 'assets'))
        break;
    }
...
function transformViews() {
  return fs.readdirAsync('website/views')
