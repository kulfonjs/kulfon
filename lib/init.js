...
function init({ dir, theme }) {
  ...
  fs.accessAsync(themeDir)
    ...
    .catch(() => console.log('Error: '.red + `There is no theme named ${theme.yellow}. Here's the list of themes: https://kulfon.net/themes/`));
...
module.exports = {
  ...
  builder: _ => _
    .default('dir', '.')
    .option('theme', { alias: 't', default: 'default' })
};
